...
const BlogPage = () => {
   ...
   const metadata = {
    title: 'Hero Medium Blog | 5 VSCode extensions/tricks',
      ...
      <div>
        ...
        <div className="py-12">
          ...
          <div className="flex flex-col justify-center items-center">
            ...
            />
            <p className="text-xl py-12">
              You can further customize the configuration of formatting rules{" "}
              <br />
              (by editing the extension settings or .prettierrc file) and also{" "}
              <br />
        ...
        <div className="py-12">
          ...
          <div className="flex flex-col justify-center items-center">
            <p className="text-xl">
              Ever encountered deeply nested HTML elements and couldn’t find the{" "}
              <br />
              exact corresponding closing tag to edit? This extension solves the{" "}
              <br />
              issue by automatically updating the closing tag when you are{" "}
              <br />
              editing the open tag.
            </p>

            <img
              src="https://miro.medium.com/v2/resize:fit:1100/1*KttBNaNYodeYF18Q7vWKjg.gif"
              alt="Code 1"
              className="py-3"
              srcset=""
            />
            <p className="text-xl py-12">
              If you are only editing HTML files, VSCode has a built-in Linked{" "}
              <br />
              Editing setting that does the same.
            </p>
            <img
              src="https://miro.medium.com/v2/resize:fit:720/format:webp/1*xI0lIZkkbJd_HH8dowg8fg.png"
              alt="Code 1"
              className="py-3"
              srcset=""
            />
            <img
              src="https://miro.medium.com/v2/resize:fit:720/format:webp/1*TdvpI3gnAU58UYfMmMosqg.png"
              alt="Code 1"
              className="py-3"
              srcset=""
            />
            <p className="text-xl py-12">
              Hopefully, this list of extensions is helpful and provides some <br />
              improvement to your day-to-day development experience!
            </p>
          </div>
        </div>
      </div>
